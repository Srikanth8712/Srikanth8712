...
into regulated data environments. Alongside this, I'm actively upskilling in
AI/ML engineering — building LLM-powered data tools and exploring agentic
workflows on top of the platforms I already work with every day.
...
sciences data engineering, and building practical AI/ML capabilities on top
...
![MCP](https://img.shields.io/badge/MCP_Connectors-6B46C1?style=flat)
![Databricks ML](https://img.shields.io/badge/Databricks_ML-FF3621?style=flat&logo=databricks&logoColor=white)
...
for agentic data access, and Terraform for IaC.
...
This is where I'm putting a lot of personal energy right now. My interest
isn't abstract — I've already shipped real AI-adjacent tooling at work and
I'm going deeper:

| What | Where I am |
|---|---|
| Snowflake Cortex Analyst | Built semantic views + natural language query layer for insurance claims data |
| MCP (Model Context Protocol) | Built MCP connectors linking LLMs to Snowflake data for agentic workflows |
| Streamlit + LLM chatbots | Shipped a self-serve analytics chatbot on top of Snowflake Cortex |
| Databricks ML & MLflow | Learning — model tracking, feature store, LLM serving on Databricks |
| LLM application patterns | RAG, tool use, agentic pipelines — exploring via personal projects |
| Prompt engineering | Actively practicing for data engineering and analytics use cases |

> My goal: be the data engineer who can *also* build and wire up the AI
> layer — not just hand off clean data and walk away.

---

## What I'm learning now — Pharma & Life Sciences

Actively building domain knowledge to transition into pharma DE roles:
...
- **[streamlit-cortex-chatbot](./streamlit-cortex-chatbot)** —
  Snowflake Cortex Analyst + Streamlit self-serve analytics chatbot POC
- **[mcp-snowflake-connector](./mcp-snowflake-connector)** —
  MCP connector enabling LLM agents to query Snowflake data directly
- **[pharma-learning-lab](./pharma-learning-lab)** —
  Structured learning path: OMOP CDM, CDISC pipelines, GxP patterns
  *(learning project)*
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat&logo=linkedin&logoColor=white)]([https://linkedin.com/in/your-profile](https://www.linkedin.com/in/srikanth-gorripati-ab45a674/)
